...
class ACGAN():
    ...
    def save_model(self):
        ...
        def save(model, model_name):
            model_path = path+"saved_model/%s.json" % model_name
            weights_path = path+"saved_model/%s_weights.hdf5" % model_name
...
if __name__ == '__main__':
    ...
    acgan = ACGAN()
    acgan.train(epochs=1, batch_size=256, sample_interval=200)
